...
class FGVCAircraft(VisionDataset):
    ...
    def __init__(
        ...
        self._data_path = os.path.join(self.root, "fgvc_aircraft")
        ...
        image_data_folder = os.path.join(self._data_path, "images")
        # labels_file = os.path.join(self._data_path, "data", f"images_{self._annotation_level}_{self._split}.txt")
        labels_file = os.path.join(self._data_path, f"images_{self._annotation_level}_{self._split}.txt")
